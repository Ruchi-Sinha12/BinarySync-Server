...
/*---------------------------------------------------------------------------
-- NAME      : CTcpServer::CTcpServer
-- PURPOSE   : Constructor for Class
-- PARAMETER : Integer value for port number
...
/*---------------------------------------------------------------------------
-- NAME      : CTcpServer::StartListening
-- PURPOSE   : Function for handling communication with the connected client.
-- PARAMETER : NA
-- AUTHOR    : Ruchi on 25.12.2023
----------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------------
-- NAME      : CTcpServer::HandleClient
-- PURPOSE   : Function appears to be a static member function
			   that serves as a wrapper to call the non-static member function
-- PARAMETER : void pointer of socket for client
-- AUTHOR    : Ruchi on 25.12.2023
-----------------------------------------------------------------------------------*/
...
/*-------------------------------------------------------------------------------------
-- NAME      : CTcpServer::HandleClientImpl
-- PURPOSE   : This function will allow the client first sends the file name, 
               followed by the file content. The server receives and processes 
			   this information, and finally, it sends a result back to the client.
-- PARAMETER : NA
-- AUTHOR    : Ruchi on 25.12.2023
--------------------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------------
-- NAME      : CTcpServer::ReceiveFile
-- PURPOSE   : Server receives a file from the client and saves it 
			   to the server's filesystem.
-- PARAMETER : 1[IN] -> const char* for file name
                2[IN] -> socket id of client
-- AUTHOR    : Ruchi on 25.12.2023
-----------------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------------
-- NAME      : CTcpServer::SaveReceivedFile
-- PURPOSE   : Function is responsible for saving the received file content
			   to a file on the server's filesystem. 
-- PARAMETER : 1[IN] -> const char* for file name
                2[IN] -> string reference for file content
-- AUTHOR    : Ruchi on 25.12.2023
-----------------------------------------------------------------------------------*/
